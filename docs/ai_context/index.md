...
> **目的**: 帮助 AI Agent 快速建立项目上下文，高效完成后续开发任务。
...
- [数据安全规范](../ai_collaboration/data_safety_policy.md) — **必读**
- [Python 编码规范](../../.agent/rules/python-coding-standards.md)
- [量化策略规范](../../.agent/rules/quant-strategy-standards.md)
...
```
1. QUICK_START.md        (必读，1分钟)
   ↓
2. SERVICE_REGISTRY.md   (必读，2分钟)
   ↓
3. data_safety_policy.md (必读，安全边界)
   ↓
4. CURRENT_STATE.md      (了解进度)
   ↓
5. 根据任务需要查阅 DATA_FLOW / DECISION_LOG / TECH_DEBT
```
