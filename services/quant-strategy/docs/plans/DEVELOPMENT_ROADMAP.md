...
### Phase 2: 长线配置 + 风控并行 (EPIC-002 + EPIC-004 部分)
**时间**: Week 2-4 (10-12 天)
...
### Phase 3: 风控完善 + 波段策略 (EPIC-004 剩余 + EPIC-003)
**时间**: Week 4-6 (12-14 天)
...
1. **立即启动 EPIC-005** - 不依赖外部数据源，可立即开始
2. **并行评估 get-stockdata 财务接口** - 确定 Phase 2 启动时间
3. **创建 EPIC-005 Story 5.1 实施计划** - 从 Universe Pool 开始
