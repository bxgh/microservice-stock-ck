...
class SnapshotRecorder:
    ...
    def __init__(self, pool_manager: Any, storage_path: str = "/app/data/snapshots"):
        raise NotImplementedError("SnapshotRecorder module dependencies are missing in gsd-worker")
