...
# =============================================================================
# ClickHouse 原生 SQL 高速初始化同步脚本 (超时优化版)
# =============================================================================
...
# 2. 行情核心表
sync_table "daily_basic" "daily_basic" "ts_code, trade_date, close, turnover_rate, turnover_rate_f, volume_ratio, pe, pe_ttm, pb, ps, ps_ttm, dv_ratio, dv_ttm, total_share, float_share, free_share, total_mv, circ_mv"
sync_table "stock_kline_daily" "stock_kline_daily" "ts_code, trade_date, open, high, low, close, pre_close, volume, amount, turnover, pct_chg, trade_status"
